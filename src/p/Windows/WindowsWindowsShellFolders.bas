...
'https://medium.com/@dbilanoski/windows-shell-folders-the-whys-the-whats-the-hows-and-a-complete-list-of-them-7e33e1b826cf

'How To Find And List Windows Shell Folders In Windows Registry
'
'1. By looking at properties of:
'Registry Key: [HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Shell Folders]
'# List them with PowerShell
'PowerShell Get-ItemProperty -Path "HKLM:SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Shell Folders"
'
'2. By looking at the names of the FolderDescriptions in:
'Registry Key: [HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FolderDescritions]
'# List them with PowerShell
...
'[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FolderDescritions]
'# List them with PowerShell
'$Folders = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FolderDescriptions"
'Get-ChildItem $Folders | select PSPath | Get-ItemProperty | select Name

Public Type ShellFolder
  Name As String
  Path As String
  CLSID As String
End Type

'Either a Path or a CLSID must be specified
Public Function TestMisconfiguredWindowShellFolder() As Phosphorus.ShellFolder
  Dim myShellFolder As Phosphorus.ShellFolder
  myShellFolder.Name = "Test Misconfigured Window Shell Folder"
  TestMisconfiguredWindowShellFolder = myShellFolder
End Function

Public Function Desktop() As Phosphorus.ShellFolder
  Dim myShellFolder As Phosphorus.ShellFolder
  myShellFolder.Name = "Desktop"
  myShellFolder.Path = "Desktop"
  Desktop = myShellFolder
End Function

Public Function MyComputer() As Phosphorus.ShellFolder
  Dim myShellFolder As Phosphorus.ShellFolder
  myShellFolder.Name = "My Computer"
  myShellFolder.Path = "MyComputerFolder"
  MyComputer = myShellFolder
End Function

Public Function RecycleBin() As Phosphorus.ShellFolder
  Dim myShellFolder As Phosphorus.ShellFolder
  myShellFolder.Name = "Recycle Bin"
  myShellFolder.Path = "RecycleBinFolder"
  RecycleBin = myShellFolder
End Function
...
Public Function CommonAdministrativeTools() As Phosphorus.ShellFolder
  Dim myShellFolder As Phosphorus.ShellFolder
  myShellFolder.Name = "Common Administrative Tools"
  myShellFolder.Path = "Common Administrative Tools"
  CommonAdministrativeTools = myShellFolder
End Function
...
Public Function UserProfile() As Phosphorus.ShellFolder
  Dim myShellFolder As Phosphorus.ShellFolder
  myShellFolder.Name = "Recycle Bin"
  myShellFolder.CLSID = "{59031a47-3f72-44a7-89c5-5595fe6b30ee}"
  UserProfile = myShellFolder
End Function
