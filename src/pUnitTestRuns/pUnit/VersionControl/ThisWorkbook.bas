...
Private Sub Workbook_Open()
  ...
  pUnitTestRuns_pUnit.References.AddReferenceToWorkbook strPhosphorusWBFullName
  ...
  pUnitTestRuns_pUnit.References.AddReferenceToWorkbook strPUnitWBFullName
  ...
  pUnitTestRuns_pUnit.References.AddReferenceToWorkbook strTestWorkbookFilepath, "pUnit"

End Sub

Private Sub Workbook_BeforeClose(Cancel As Boolean)
  pUnitTestRuns_pUnit.References.RemoveAllAddedReferences
