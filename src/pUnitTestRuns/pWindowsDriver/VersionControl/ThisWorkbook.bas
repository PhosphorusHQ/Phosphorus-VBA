...
Private Sub Workbook_Open()
  ...
  pUnitTestRuns_pWindowsDriver.References.AddReferenceToWorkbook strPhosphorusWBFullName
  ...
  pUnitTestRuns_pWindowsDriver.References.AddReferenceToWorkbook strPUnitWBFullName
...
Private Sub Workbook_BeforeClose(Cancel As Boolean)
  pUnitTestRuns_pWindowsDriver.References.RemoveAllAddedReferences
