...
Private Const ThisVBProjectName = "pUnitTestRuns_pWindowsDriver"
...
Private Sub Workbook_Open()
  ...
  pUnitTestRuns_pWindowsDriver.References.AddReferenceToWorkbookOrLibrary strPhosphorusWBFullName
  ...
  pUnitTestRuns_pWindowsDriver.References.AddReferenceToWorkbookOrLibrary strPUnitWBFullName
  ...
  pUnitTestRuns_pWindowsDriver.References.AddReferenceToWorkbookOrLibrary strTestWorkbookFilepath, "pUnit"

End Sub

Private Sub Test_ListAllReferencesInProject()
  pUnitTestRuns_pWindowsDriver.References.ListAllReferencesInAProject ThisVBProjectName
End Sub
...
Private Sub ImportAllPhosphorusSourceCode()
  Phosphorus.ModuleManagement.ImportModulesFromFolder "src\pUnitTestRuns\pWindowsDriver", ""
End Sub
