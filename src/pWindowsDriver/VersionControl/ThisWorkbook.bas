...
Private Sub Workbook_Open()
  ...
  pWinDriver.References.AddReferenceToWorkbook strPhosphorusWBFullName
  ...
  pWinDriver.References.AddReferenceToWorkbook strPPathWBFullName
...
Private Sub ExportPhosphorusSourceCode()
  Phosphorus.ModuleManagement.ExportModulesWithFolders SubFolderForExport:="\src\pWindowsDriver", projectName:="pWinDriver"
End Sub
