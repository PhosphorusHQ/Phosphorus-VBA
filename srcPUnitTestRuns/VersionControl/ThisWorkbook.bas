...
Private Sub Workbook_Open()
  ...
  pUnitTestRuns.References.AddReferenceToWorkbook strPhosphorusWBFullName
  ...
  pUnitTestRuns.References.AddReferenceToWorkbook strPUnitWBFullName
...
Private Sub Workbook_BeforeClose(Cancel As Boolean)
  pUnitTestRuns.References.RemoveAllAddedReferences
...
Private Sub ExportPhosphorusSourceCode()
  Phosphorus.ModuleManagement.ExportModulesWithFolders SubFolderForExport:="\srcPUnitTestRuns", projectName:="pUnitTestRuns"
End Sub
