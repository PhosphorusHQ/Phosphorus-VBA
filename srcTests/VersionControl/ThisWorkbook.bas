...
Private Sub ExportPhosphorusSourceCode()
  Phosphorus.ModuleManagement.ExportModulesWithFolders SubFolderForExport:="\srcTests", projectName:="PhosphorusTests"
End Sub
...
'  SetModulesToKeep
  Phosphorus.ModuleManagement.ImportModulesFromFolder "srcTests", ""
End Sub
